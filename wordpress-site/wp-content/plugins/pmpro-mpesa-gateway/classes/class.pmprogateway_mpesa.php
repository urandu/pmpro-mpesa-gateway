	...
	class PMProGateway_mpesa extends PMProGateway
	{
		...
		static function pmpro_payment_option_fields($values, $gateway)
        {
            ...
            <tr class="gateway gateway_mpesa" <?php if($gateway != "mpesa") { ?>style="display: none;"<?php } ?>>
                ...
                <td>
                    <input type="text" id="mpesa_secret_key" name="mpesa_secret_key" size="60" value="<?php echo esc_attr($values['mpesa_secret_key'])?>" />
                </td>
            </tr>
            <tr class="gateway gateway_mpesa" <?php if($gateway != "mpesa") { ?>style="display: none;"<?php } ?>>
                <th scope="row" valign="top">
                ...
                <td>
                    <input type="text" id="mpesa_api_key" name="mpesa_api_key" size="60" value="<?php echo esc_attr($values['mpesa_api_key'])?>" />
                </td>
            </tr>
            <tr class="gateway gateway_mpesa" <?php if($gateway != "mpesa") { ?>style="display: none;"<?php } ?>>
                <th scope="row" valign="top">
